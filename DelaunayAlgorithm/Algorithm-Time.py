...
def delaunayWalk(points):
    #Eliminar los puntos repetidos del conjunto inicial
    points = unifiqy(points)
...
if __name__ == '__main__':
    ...
    points = randomPoints(300,100,500)
    #points =[Point2D(200,200),Point2D(200,300),Point2D(300,300),Point2D(300,200),Point2D(400,200),Point2D(400,300),Point2D(500,200),Point2D(500,300),
    #         Point2D(200,100),Point2D(300,100),Point2D(400,100),Point2D(500,100)]
    #shuffle(points)
    ...
    triangulationLineal = delaunayLineal(points)
    endLineal = time.time()

    triangulation = delaunayWalk(points)
    endWalk = time.time()

    print "Time lineal" + str(endLineal - startLineal)
    print "Time walk" + str(endWalk - endLineal)
